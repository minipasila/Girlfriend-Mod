 ...
 *   Lnet/minecraft/test/TestServer;create(Ljava/lang/Thread;Lnet/minecraft/world/level/storage/LevelStorage$Session;Lnet/minecraft/resource/ResourcePackManager;Ljava/util/Optional;Z)Lnet/minecraft/test/TestServer;
 *
 * Internal private/static methods:
 *   Lnet/minecraft/test/TestBootstrap;empty(Ljava/lang/String;)V
 *   Lnet/minecraft/test/TestBootstrap;copyPacks(Ljava/lang/String;Ljava/lang/String;)V
 */
