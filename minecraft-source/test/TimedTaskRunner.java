 ...
 *   Lnet/minecraft/test/TimedTask;create(Ljava/lang/Runnable;)Lnet/minecraft/test/TimedTask;
 *   Lnet/minecraft/test/TimedTask;create(JLjava/lang/Runnable;)Lnet/minecraft/test/TimedTask;
 *   Lnet/minecraft/test/GameTestState;fail(Lnet/minecraft/test/TestException;)V
 *   Lnet/minecraft/text/Text;translatable(Ljava/lang/String;[Ljava/lang/Object;)Lnet/minecraft/text/MutableText;
 *   Lnet/minecraft/test/TimedTaskRunner$Trigger;trigger(I)V
 ...
 *   Lnet/minecraft/test/TimedTaskRunner;runTasks(I)V
 *   Lnet/minecraft/test/TimedTaskRunner;tryRun(Ljava/lang/Runnable;)V
 */
