 ...
 *   Lnet/minecraft/structure/DesertTempleGenerator;adjustToMinHeight(Lnet/minecraft/world/WorldAccess;I)Z
 *   Lnet/minecraft/structure/DesertTempleGenerator;fillWithOutline(Lnet/minecraft/world/StructureWorldAccess;Lnet/minecraft/util/math/BlockBox;IIIIIILnet/minecraft/block/BlockState;Lnet/minecraft/block/BlockState;Z)V
 *   Lnet/minecraft/structure/DesertTempleGenerator;fillDownwards(Lnet/minecraft/world/StructureWorldAccess;Lnet/minecraft/block/BlockState;IIILnet/minecraft/util/math/BlockBox;)V
 *   Lnet/minecraft/structure/DesertTempleGenerator;addBlock(Lnet/minecraft/world/StructureWorldAccess;Lnet/minecraft/block/BlockState;IIILnet/minecraft/util/math/BlockBox;)V
 *   Lnet/minecraft/structure/DesertTempleGenerator;addChest(Lnet/minecraft/world/StructureWorldAccess;Lnet/minecraft/util/math/BlockBox;Lnet/minecraft/util/math/random/Random;IIILnet/minecraft/registry/RegistryKey;)Z
 ...
 *   Lnet/minecraft/structure/DesertTempleGenerator;offsetPos(III)Lnet/minecraft/util/math/BlockPos$Mutable;
 ...
 *   Lnet/minecraft/structure/DesertTempleGenerator;applyXTransform(II)I
 *   Lnet/minecraft/structure/DesertTempleGenerator;applyYTransform(I)I
 *   Lnet/minecraft/structure/DesertTempleGenerator;applyZTransform(II)I
 */
