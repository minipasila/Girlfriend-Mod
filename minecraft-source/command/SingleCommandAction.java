 ...
 *   Lnet/minecraft/command/Forkable;execute(Ljava/lang/Object;Ljava/util/List;Lcom/mojang/brigadier/context/ContextChain;Lnet/minecraft/command/ExecutionFlags;Lnet/minecraft/command/ExecutionControl;)V
 ...
 *   Lnet/minecraft/command/ReturnValueConsumer;chain(Lnet/minecraft/command/ReturnValueConsumer;Lnet/minecraft/command/ReturnValueConsumer;)Lnet/minecraft/command/ReturnValueConsumer;
 *   Lnet/minecraft/server/command/AbstractServerCommandSource;withReturnValueConsumer(Lnet/minecraft/command/ReturnValueConsumer;)Lnet/minecraft/server/command/AbstractServerCommandSource;
 ...
 *   Lnet/minecraft/command/FixedCommandAction;bind(Ljava/lang/Object;)Lnet/minecraft/command/CommandAction;
