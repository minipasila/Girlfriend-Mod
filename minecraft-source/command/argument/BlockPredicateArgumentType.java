 ...
 *   Lnet/minecraft/command/argument/BlockArgumentParser$TagResult;tag()Lnet/minecraft/registry/entry/RegistryEntryList;
 *   Lnet/minecraft/command/argument/BlockArgumentParser$TagResult;vagueProperties()Ljava/util/Map;
 *   Lnet/minecraft/command/argument/BlockArgumentParser$TagResult;nbt()Lnet/minecraft/nbt/NbtCompound;
 *   Lnet/minecraft/command/argument/BlockArgumentParser$BlockResult;blockState()Lnet/minecraft/block/BlockState;
 *   Lnet/minecraft/command/argument/BlockArgumentParser$BlockResult;properties()Ljava/util/Map;
 *   Lnet/minecraft/command/argument/BlockArgumentParser$BlockResult;nbt()Lnet/minecraft/nbt/NbtCompound;
 *
 * Internal private/static methods:
 *   Lnet/minecraft/command/argument/BlockPredicateArgumentType;parse(Lnet/minecraft/registry/RegistryWrapper;Lcom/mojang/brigadier/StringReader;)Lnet/minecraft/command/argument/BlockPredicateArgumentType$BlockPredicate;
 *   Lnet/minecraft/command/argument/BlockPredicateArgumentType;parse(Lcom/mojang/brigadier/StringReader;)Lnet/minecraft/command/argument/BlockPredicateArgumentType$BlockPredicate;
 */
