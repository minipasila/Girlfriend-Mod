 ...
 *   Lnet/minecraft/command/argument/ItemStringReader;consume(Lcom/mojang/brigadier/StringReader;)Lnet/minecraft/command/argument/ItemStringReader$ItemResult;
 *   Lnet/minecraft/command/argument/ItemStringReader$ItemResult;item()Lnet/minecraft/registry/entry/RegistryEntry;
 *   Lnet/minecraft/command/argument/ItemStringReader$ItemResult;components()Lnet/minecraft/component/ComponentChanges;
 *
 * Internal private/static methods:
 *   Lnet/minecraft/command/argument/ItemStackArgumentType;parse(Lcom/mojang/brigadier/StringReader;)Lnet/minecraft/command/argument/ItemStackArgument;
 */
