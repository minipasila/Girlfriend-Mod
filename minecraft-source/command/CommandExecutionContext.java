 ...
 *   Lnet/minecraft/command/CommandQueueEntry;frame()Lnet/minecraft/command/Frame;
 *   Lnet/minecraft/command/CommandQueueEntry;execute(Lnet/minecraft/command/CommandExecutionContext;)V
 *
