 ...
 *   Lnet/minecraft/datafixer/fix/ItemNbtFix;fixNbt(Lcom/mojang/datafixers/types/Type;Ljava/util/function/Predicate;Ljava/util/function/UnaryOperator;)Ljava/util/function/UnaryOperator;
 *
 * Internal private/static methods:
 *   Lnet/minecraft/datafixer/fix/BlockPosFormatFix;addEntityFixes(Ljava/util/List;)V
 *   Lnet/minecraft/datafixer/fix/BlockPosFormatFix;addBlockEntityFixes(Ljava/util/List;)V
 *   Lnet/minecraft/datafixer/fix/BlockPosFormatFix;writeFixAndRead(Ljava/lang/String;Lcom/mojang/datafixers/types/Type;Lcom/mojang/datafixers/types/Type;Ljava/util/function/Function;)Lcom/mojang/datafixers/TypeRewriteRule;
 *   Lnet/minecraft/datafixer/fix/BlockPosFormatFix;fixTypeEverywhereTyped(Ljava/lang/String;Lcom/mojang/datafixers/types/Type;Ljava/util/function/Function;)Lcom/mojang/datafixers/TypeRewriteRule;
 *   Lnet/minecraft/datafixer/fix/BlockPosFormatFix;createFixRule(Lcom/mojang/datafixers/DSL$TypeReference;Ljava/lang/String;Ljava/util/Map;)Lcom/mojang/datafixers/TypeRewriteRule;
 *   Lnet/minecraft/datafixer/fix/BlockPosFormatFix;fixOldBlockPosFormat(Lcom/mojang/datafixers/Typed;Ljava/util/Map;)Lcom/mojang/datafixers/Typed;
 */
