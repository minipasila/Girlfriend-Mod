 ...
 *   Lnet/minecraft/world/World;addImportantParticleClient(Lnet/minecraft/particle/ParticleEffect;DDDDDD)V
 ...
 *   Lnet/minecraft/block/BubbleColumnBlock;update(Lnet/minecraft/world/WorldAccess;Lnet/minecraft/util/math/BlockPos;Lnet/minecraft/block/BlockState;Lnet/minecraft/block/BlockState;)V
 *   Lnet/minecraft/block/BubbleColumnBlock;createCodec(Ljava/util/function/Function;)Lcom/mojang/serialization/MapCodec;
 */
...
implements FluidDrainable {
    ...
    protected void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity, EntityCollisionHandler handler) {
        ...
        boolean bl2 = bl = lv.getCollisionShape(world, pos).isEmpty() && lv.getFluidState().isEmpty();
        if (bl) {
