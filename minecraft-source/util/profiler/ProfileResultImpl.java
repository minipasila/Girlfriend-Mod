 ...
 *   Lnet/minecraft/util/crash/ReportType;addHeaderAndNugget(Ljava/lang/StringBuilder;Ljava/util/List;)V
 *   Lnet/minecraft/GameVersion;id()Ljava/lang/String;
 *
 * Internal private/static methods:
 *   Lnet/minecraft/util/profiler/ProfileResultImpl;asString(JI)Ljava/lang/String;
 *   Lnet/minecraft/util/profiler/ProfileResultImpl;appendTiming(ILjava/lang/String;Ljava/lang/StringBuilder;)V
 *   Lnet/minecraft/util/profiler/ProfileResultImpl;setupCounters()Ljava/util/Map;
 *   Lnet/minecraft/util/profiler/ProfileResultImpl;appendCounterDump(Ljava/util/Map;Ljava/lang/StringBuilder;I)V
 *   Lnet/minecraft/util/profiler/ProfileResultImpl;indent(Ljava/lang/StringBuilder;I)Ljava/lang/StringBuilder;
 *   Lnet/minecraft/util/profiler/ProfileResultImpl;appendCounter(ILjava/lang/String;Lnet/minecraft/util/profiler/ProfileResultImpl$CounterInfo;ILjava/lang/StringBuilder;)V
 */
