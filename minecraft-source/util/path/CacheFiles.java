 ...
 *   Lnet/minecraft/util/path/CacheFiles;findCacheFiles(Ljava/nio/file/Path;)Ljava/util/List;
 *   Lnet/minecraft/util/path/CacheFiles;toCacheEntries(Ljava/util/List;)Ljava/util/List;
 */
