 ...
 *   Lnet/minecraft/util/Util;decodeFixedLengthArray(Ljava/util/stream/IntStream;I)Lcom/mojang/serialization/DataResult;
 *
 * Internal private/static methods:
 *   Lnet/minecraft/util/Uuids;toIntArray(JJ)[I
 *   Lnet/minecraft/util/Uuids;toUuid([I)Ljava/util/UUID;
 *   Lnet/minecraft/util/Uuids;toIntArray(Ljava/util/UUID;)[I
 */
