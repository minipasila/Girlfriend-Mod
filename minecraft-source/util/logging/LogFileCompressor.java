 ...
 *   Lnet/minecraft/util/logging/LogFileCompressor$LogFileIterable;toIdSet()Ljava/util/Set;
 *   Lnet/minecraft/util/logging/LogFileCompressor$Uncompressed;path()Ljava/nio/file/Path;
 *
