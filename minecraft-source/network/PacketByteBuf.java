 ...
 *   Lnet/minecraft/network/codec/PacketDecoder;decode(Ljava/lang/Object;)Ljava/lang/Object;
 *   Lnet/minecraft/network/codec/PacketEncoder;encode(Ljava/lang/Object;Ljava/lang/Object;)V
 ...
 *   Lnet/minecraft/network/encoding/VelocityEncoding;readVelocity(Lio/netty/buffer/ByteBuf;)Lnet/minecraft/util/math/Vec3d;
 *   Lnet/minecraft/network/encoding/VelocityEncoding;writeVelocity(Lio/netty/buffer/ByteBuf;Lnet/minecraft/util/math/Vec3d;)V
 *   Lnet/minecraft/network/encoding/VarLongs;read(Lio/netty/buffer/ByteBuf;)J
 *   Lnet/minecraft/network/encoding/VarLongs;write(Lio/netty/buffer/ByteBuf;J)Lio/netty/buffer/ByteBuf;
 ...
 *   Lnet/minecraft/network/encoding/StringEncoding;decode(Lio/netty/buffer/ByteBuf;I)Ljava/lang/String;
 *   Lnet/minecraft/network/encoding/StringEncoding;encode(Lio/netty/buffer/ByteBuf;Ljava/lang/CharSequence;I)V
 ...
 *   Lnet/minecraft/network/PacketByteBuf;writeLongArray(Lio/netty/buffer/ByteBuf;[J)V
 *   Lnet/minecraft/network/PacketByteBuf;writeFixedLengthLongArray(Lio/netty/buffer/ByteBuf;[J)V
 *   Lnet/minecraft/network/PacketByteBuf;readLongArray(Lio/netty/buffer/ByteBuf;)[J
 *   Lnet/minecraft/network/PacketByteBuf;readFixedLengthLongArray(Lio/netty/buffer/ByteBuf;[J)[J
 ...
 *   Lnet/minecraft/network/PacketByteBuf;readVec3d(Lio/netty/buffer/ByteBuf;)Lnet/minecraft/util/math/Vec3d;
 *   Lnet/minecraft/network/PacketByteBuf;writeVec3d(Lio/netty/buffer/ByteBuf;Lnet/minecraft/util/math/Vec3d;)V
 ...
 *   Lnet/minecraft/network/PacketByteBuf;readSyncId(Lio/netty/buffer/ByteBuf;)I
 *   Lnet/minecraft/network/PacketByteBuf;writeSyncId(Lio/netty/buffer/ByteBuf;I)V
 ...
 *   Lnet/minecraft/network/PacketByteBuf;capacity(I)Lnet/minecraft/network/PacketByteBuf;
