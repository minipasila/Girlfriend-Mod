 ...
 *   Lnet/minecraft/world/storage/StorageIoWorker$Priority;values()[Lnet/minecraft/world/storage/StorageIoWorker$Priority;
 *   Lnet/minecraft/world/storage/StorageKey;type()Ljava/lang/String;
 ...
 *   Lnet/minecraft/nbt/NbtCompound;accept(Lnet/minecraft/nbt/scanner/NbtScanner;)V
 ...
 *   Lnet/minecraft/world/storage/StorageIoWorker$Result;copyNbt()Lnet/minecraft/nbt/NbtCompound;
 *
 * Internal private/static methods:
 *   Lnet/minecraft/world/storage/StorageIoWorker;computeBlendingStatus(II)Ljava/util/concurrent/CompletableFuture;
 *   Lnet/minecraft/world/storage/StorageIoWorker;run(Ljava/util/function/Supplier;)Ljava/util/concurrent/CompletableFuture;
 *   Lnet/minecraft/world/storage/StorageIoWorker;run(Lnet/minecraft/world/storage/StorageIoWorker$Callable;)Ljava/util/concurrent/CompletableFuture;
 ...
 *   Lnet/minecraft/world/storage/StorageIoWorker;scanChunk(Lnet/minecraft/util/math/ChunkPos;Lnet/minecraft/nbt/scanner/NbtScanner;)Ljava/util/concurrent/CompletableFuture;
 */
