 ...
 *   Lnet/minecraft/util/profiling/jfr/FlightProfiler;onChunkRegionRead(Lnet/minecraft/world/storage/StorageKey;Lnet/minecraft/util/math/ChunkPos;Lnet/minecraft/world/storage/ChunkCompressionFormat;I)V
 *   Lnet/minecraft/util/Identifier;tryParse(Ljava/lang/String;)Lnet/minecraft/util/Identifier;
 *   Lnet/minecraft/world/storage/ChunkCompressionFormat;wrap(Ljava/io/InputStream;)Ljava/io/InputStream;
 *   Lnet/minecraft/world/storage/ChunkCompressionFormat;exists(I)Z
 *   Lnet/minecraft/world/storage/ChunkCompressionFormat;wrap(Ljava/io/OutputStream;)Ljava/io/OutputStream;
