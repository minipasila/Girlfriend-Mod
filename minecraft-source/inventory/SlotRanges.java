 ...
 *   Lnet/minecraft/inventory/SlotRange;create(Ljava/lang/String;Lit/unimi/dsi/fastutil/ints/IntList;)Lnet/minecraft/inventory/SlotRange;
 ...
 *   Lnet/minecraft/inventory/SlotRanges;create(Ljava/lang/String;I)Lnet/minecraft/inventory/SlotRange;
 *   Lnet/minecraft/inventory/SlotRanges;create(Ljava/lang/String;Lit/unimi/dsi/fastutil/ints/IntList;)Lnet/minecraft/inventory/SlotRange;
 *   Lnet/minecraft/inventory/SlotRanges;create(Ljava/lang/String;[I)Lnet/minecraft/inventory/SlotRange;
 *   Lnet/minecraft/inventory/SlotRanges;createAndAdd(Ljava/util/List;Ljava/lang/String;I)V
 *   Lnet/minecraft/inventory/SlotRanges;createAndAdd(Ljava/util/List;Ljava/lang/String;II)V
 *   Lnet/minecraft/inventory/SlotRanges;createAndAdd(Ljava/util/List;Ljava/lang/String;[I)V
 */
