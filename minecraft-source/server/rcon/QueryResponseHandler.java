 ...
 *   Lnet/minecraft/server/rcon/BufferHelper;toHex(B)Ljava/lang/String;
 *   Lnet/minecraft/server/rcon/DataStreamHelper;write(I)V
 *   Lnet/minecraft/server/rcon/DataStreamHelper;write([B)V
 *   Lnet/minecraft/server/rcon/DataStreamHelper;writeBytes(Ljava/lang/String;)V
 *   Lnet/minecraft/server/rcon/DataStreamHelper;writeShort(S)V
 *   Lnet/minecraft/server/rcon/DataStreamHelper;bytes()[B
 *   Lnet/minecraft/server/rcon/QueryResponseHandler$Query;startedBefore(J)Ljava/lang/Boolean;
 *
