 ...
 *   Lnet/minecraft/server/dedicated/MinecraftDedicatedServer;saveAll(ZZZ)Z
 *   Lnet/minecraft/server/dedicated/MinecraftDedicatedServer;stop(Z)V
 *   Lnet/minecraft/server/dedicated/MinecraftDedicatedServer;sendMessage(Lnet/minecraft/text/Text;)V
