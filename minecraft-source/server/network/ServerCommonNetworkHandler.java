 ...
 *   Lnet/minecraft/network/listener/ServerCommonPacketListener;onPacketException(Lnet/minecraft/network/packet/Packet;Ljava/lang/Exception;)V
 *   Lnet/minecraft/server/MinecraftServer;onPacketException(Ljava/lang/Throwable;Lnet/minecraft/network/packet/PacketType;)V
 ...
 *   Lnet/minecraft/network/packet/c2s/common/CustomClickActionC2SPacket;id()Lnet/minecraft/util/Identifier;
 *   Lnet/minecraft/network/packet/c2s/common/CustomClickActionC2SPacket;payload()Ljava/util/Optional;
 ...
 *   Lnet/minecraft/network/packet/c2s/common/ResourcePackStatusC2SPacket;id()Ljava/util/UUID;
 ...
 *   Lnet/minecraft/server/network/ServerCommonNetworkHandler;send(Lnet/minecraft/network/packet/Packet;Lio/netty/channel/ChannelFutureListener;)V
