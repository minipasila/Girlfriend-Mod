 ...
 *   Lnet/minecraft/command/argument/SwizzleArgumentType;swizzle()Lnet/minecraft/command/argument/SwizzleArgumentType;
 ...
 *   Lnet/minecraft/command/argument/ScoreHolderArgumentType;scoreHolders()Lnet/minecraft/command/argument/ScoreHolderArgumentType;
 ...
 *   Lnet/minecraft/command/argument/ScoreHolderArgumentType;scoreHolder()Lnet/minecraft/command/argument/ScoreHolderArgumentType;
 *   Lnet/minecraft/command/argument/NumberRangeArgumentType;intRange()Lnet/minecraft/command/argument/NumberRangeArgumentType$IntRangeArgumentType;
 ...
 *   Lnet/minecraft/command/argument/SlotRangeArgumentType;slotRange()Lnet/minecraft/command/argument/SlotRangeArgumentType;
 ...
 *   Lnet/minecraft/server/command/AbstractServerCommandSource;withDummyReturnValueConsumer()Lnet/minecraft/server/command/AbstractServerCommandSource;
 *   Lnet/minecraft/command/ExecutionControl;enqueueAction(Lnet/minecraft/command/CommandAction;)V
 *   Lnet/minecraft/command/Frame;returnValueConsumer()Lnet/minecraft/command/ReturnValueConsumer;
 *   Lnet/minecraft/command/CommandFunctionAction;bind(Ljava/lang/Object;)Lnet/minecraft/command/CommandAction;
 *   Lnet/minecraft/text/Text;translatable(Ljava/lang/String;)Lnet/minecraft/text/MutableText;
 *   Lnet/minecraft/text/Text;translatable(Ljava/lang/String;[Ljava/lang/Object;)Lnet/minecraft/text/MutableText;
 *   Lnet/minecraft/server/command/ExecuteCommand$Condition;test(Lcom/mojang/brigadier/context/CommandContext;)Z
 *   Lnet/minecraft/server/command/ExecuteCommand$ExistsCondition;test(Lcom/mojang/brigadier/context/CommandContext;)I
 *   Lnet/minecraft/command/argument/NbtPathArgumentType;nbtPath()Lnet/minecraft/command/argument/NbtPathArgumentType;
 *   Lnet/minecraft/command/argument/RegistryEntryPredicateArgumentType$EntryPredicate;test(Ljava/lang/Object;)Z
 ...
 *   Lnet/minecraft/server/command/ExecuteCommand;addOnArguments(Lcom/mojang/brigadier/tree/CommandNode;Lcom/mojang/brigadier/builder/LiteralArgumentBuilder;)Lcom/mojang/brigadier/builder/LiteralArgumentBuilder;
 ...
 *   Lnet/minecraft/server/command/ExecuteCommand;createEntityModifier(Ljava/util/function/Function;)Lcom/mojang/brigadier/RedirectModifier;
 *   Lnet/minecraft/server/command/ExecuteCommand;createMultiEntityModifier(Ljava/util/function/Function;)Lcom/mojang/brigadier/RedirectModifier;
 ...
 *   Lnet/minecraft/server/command/ExecuteCommand;countMatchingItems(Lnet/minecraft/server/command/ServerCommandSource;Lnet/minecraft/util/math/BlockPos;Lnet/minecraft/inventory/SlotRange;Ljava/util/function/Predicate;)I
 *   Lnet/minecraft/server/command/ExecuteCommand;countMatchingItems(Ljava/lang/Iterable;Lnet/minecraft/inventory/SlotRange;Ljava/util/function/Predicate;)I
 *   Lnet/minecraft/server/command/ExecuteCommand;testLootCondition(Lnet/minecraft/server/command/ServerCommandSource;Lnet/minecraft/registry/entry/RegistryEntry;)Z
 ...
 *   Lnet/minecraft/server/command/ExecuteCommand;testScoreCondition(Lcom/mojang/brigadier/context/CommandContext;Lnet/minecraft/server/command/ExecuteCommand$ScoreComparisonPredicate;)Z
 ...
 *   Lnet/minecraft/server/command/ExecuteCommand;summon(Lnet/minecraft/server/command/ServerCommandSource;Lnet/minecraft/registry/entry/RegistryEntry$Reference;)Lnet/minecraft/server/command/ServerCommandSource;
 */
