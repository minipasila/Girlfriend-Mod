 ...
 *   Lnet/minecraft/server/dedicated/ServerPropertiesHandler;createDimensionsRegistryHolder(Lnet/minecraft/registry/RegistryWrapper$WrapperLookup;)Lnet/minecraft/world/dimension/DimensionOptionsRegistryHolder;
 ...
 *   Lnet/minecraft/server/Main;writePidFile(Ljava/nio/file/Path;)V
 *   Lnet/minecraft/server/Main;createServerConfig(Lnet/minecraft/server/dedicated/ServerPropertiesHandler;Lcom/mojang/serialization/Dynamic;ZLnet/minecraft/resource/ResourcePackManager;)Lnet/minecraft/server/SaveLoading$ServerConfig;
 *   Lnet/minecraft/server/Main;forceUpgradeWorld(Lnet/minecraft/world/level/storage/LevelStorage$Session;Lnet/minecraft/world/SaveProperties;Lcom/mojang/datafixers/DataFixer;ZLjava/util/function/BooleanSupplier;Lnet/minecraft/registry/DynamicRegistryManager;Z)V
 *   Lnet/minecraft/server/Main;createWorld(Lnet/minecraft/server/dedicated/ServerPropertiesLoader;Lnet/minecraft/server/SaveLoading$LoadContextSupplierContext;Lnet/minecraft/registry/Registry;ZZ)Lnet/minecraft/server/SaveLoading$LoadContext;
 */
