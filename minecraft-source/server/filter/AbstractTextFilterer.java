 ...
 *   Lnet/minecraft/server/filter/V1TextFilterer;load(Ljava/lang/String;)Lnet/minecraft/server/filter/AbstractTextFilterer;
 *   Lnet/minecraft/network/message/FilterMask;markFiltered(I)V
 *   Lnet/minecraft/util/LenientJsonParser;parse(Ljava/io/Reader;)Lcom/google/gson/JsonElement;
