 ...
 *   Lnet/minecraft/MinecraftVersion;create(Ljava/lang/String;Ljava/lang/String;Z)Lnet/minecraft/GameVersion;
 *   Lnet/minecraft/MinecraftVersion;fromJson(Lcom/google/gson/JsonObject;)Lnet/minecraft/GameVersion;
 *   Lnet/minecraft/MinecraftVersion;create(Ljava/lang/String;Ljava/lang/String;)Lnet/minecraft/GameVersion;
 */
...
public class MinecraftVersion {
    ...
    public static GameVersion create(String id, String name, boolean stable) {
        return new GameVersion.Impl(id, name, new SaveVersion(4554, "main"), SharedConstants.getProtocolVersion(), PackVersion.of(69, 0), PackVersion.of(88, 0), new Date(), stable);
    }
