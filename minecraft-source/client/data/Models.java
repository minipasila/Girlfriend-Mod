 ...
 *   Lnet/minecraft/client/data/Models;block(Ljava/lang/String;Ljava/lang/String;[Lnet/minecraft/client/data/TextureKey;)Lnet/minecraft/client/data/Model;
 *   Lnet/minecraft/client/data/Models;block(Ljava/lang/String;[Lnet/minecraft/client/data/TextureKey;)Lnet/minecraft/client/data/Model;
 *   Lnet/minecraft/client/data/Models;make([Lnet/minecraft/client/data/TextureKey;)Lnet/minecraft/client/data/Model;
 *   Lnet/minecraft/client/data/Models;item(Ljava/lang/String;[Lnet/minecraft/client/data/TextureKey;)Lnet/minecraft/client/data/Model;
 *   Lnet/minecraft/client/data/Models;openBundle(Ljava/lang/String;Ljava/lang/String;[Lnet/minecraft/client/data/TextureKey;)Lnet/minecraft/client/data/Model;
 */
