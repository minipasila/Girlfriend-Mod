 ...
 *   Lnet/minecraft/client/session/telemetry/PropertyMap;createCodec(Ljava/util/List;)Lcom/mojang/serialization/MapCodec;
 ...
 *   Lnet/minecraft/client/session/telemetry/TelemetryEventType$Builder;properties(Ljava/util/List;)Lnet/minecraft/client/session/telemetry/TelemetryEventType$Builder;
 *   Lnet/minecraft/client/session/telemetry/TelemetryEventType$Builder;properties(Lnet/minecraft/client/session/telemetry/TelemetryEventProperty;)Lnet/minecraft/client/session/telemetry/TelemetryEventType$Builder;
 *   Lnet/minecraft/client/session/telemetry/TelemetryEventType$Builder;build()Lnet/minecraft/client/session/telemetry/TelemetryEventType;
 *   Lnet/minecraft/client/session/telemetry/TelemetryEventType$Builder;optional()Lnet/minecraft/client/session/telemetry/TelemetryEventType$Builder;
 *
