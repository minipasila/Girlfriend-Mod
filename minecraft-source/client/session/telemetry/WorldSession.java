 ...
 *   Lnet/minecraft/client/session/telemetry/TelemetrySender;decorate(Ljava/util/function/Consumer;)Lnet/minecraft/client/session/telemetry/TelemetrySender;
 *   Lnet/minecraft/client/session/telemetry/PerformanceMetricsEvent;tick(Lnet/minecraft/client/session/telemetry/TelemetrySender;)V
 *   Lnet/minecraft/client/session/telemetry/WorldLoadedEvent;send(Lnet/minecraft/client/session/telemetry/TelemetrySender;)Z
 *   Lnet/minecraft/client/session/telemetry/WorldLoadTimesEvent;send(Lnet/minecraft/client/session/telemetry/TelemetrySender;)V
 *   Lnet/minecraft/client/session/telemetry/WorldUnloadedEvent;send(Lnet/minecraft/client/session/telemetry/TelemetrySender;)V
