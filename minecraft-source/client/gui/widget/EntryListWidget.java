 ...
 *   Lnet/minecraft/client/gui/widget/EntryListWidget$Entry;render(Lnet/minecraft/client/gui/DrawContext;IIZF)V
 *   Lnet/minecraft/client/gui/DrawContext;fill(IIIII)V
 *   Lnet/minecraft/text/Text;translatable(Ljava/lang/String;[Ljava/lang/Object;)Lnet/minecraft/text/MutableText;
 *   Lnet/minecraft/util/Identifier;ofVanilla(Ljava/lang/String;)Lnet/minecraft/util/Identifier;
 *
 * Internal private/static methods:
 *   Lnet/minecraft/client/gui/widget/EntryListWidget;scrollTo(Lnet/minecraft/client/gui/widget/EntryListWidget$Entry;)V
 *   Lnet/minecraft/client/gui/widget/EntryListWidget;addEntry(Lnet/minecraft/client/gui/widget/EntryListWidget$Entry;)I
 *   Lnet/minecraft/client/gui/widget/EntryListWidget;addEntry(Lnet/minecraft/client/gui/widget/EntryListWidget$Entry;I)I
 *   Lnet/minecraft/client/gui/widget/EntryListWidget;addEntryToTop(Lnet/minecraft/client/gui/widget/EntryListWidget$Entry;I)V
 *   Lnet/minecraft/client/gui/widget/EntryListWidget;removeEntry(Lnet/minecraft/client/gui/widget/EntryListWidget$Entry;)V
 *   Lnet/minecraft/client/gui/widget/EntryListWidget;children()Ljava/util/List;
 *   Lnet/minecraft/client/gui/widget/EntryListWidget;position(III)V
 *   Lnet/minecraft/client/gui/widget/EntryListWidget;position(IIII)V
 *   Lnet/minecraft/client/gui/widget/EntryListWidget;drawMenuListBackground(Lnet/minecraft/client/gui/DrawContext;)V
 ...
 *   Lnet/minecraft/client/gui/widget/EntryListWidget;drawHeaderAndFooterSeparators(Lnet/minecraft/client/gui/DrawContext;)V
 *   Lnet/minecraft/client/gui/widget/EntryListWidget;drawScrollbar(Lnet/minecraft/client/gui/DrawContext;II)V
 *   Lnet/minecraft/client/gui/widget/EntryListWidget;scroll(I)V
 *   Lnet/minecraft/client/gui/widget/EntryListWidget;renderEntry(Lnet/minecraft/client/gui/DrawContext;IIFLnet/minecraft/client/gui/widget/EntryListWidget$Entry;)V
 *   Lnet/minecraft/client/gui/widget/EntryListWidget;drawSelectionHighlight(Lnet/minecraft/client/gui/DrawContext;Lnet/minecraft/client/gui/widget/EntryListWidget$Entry;I)V
 */
