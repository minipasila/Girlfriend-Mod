 ...
 *   Lnet/minecraft/client/gui/screen/recipebook/RecipeBookWidget;initialize(IILnet/minecraft/client/MinecraftClient;Z)V
 ...
 *   Lnet/minecraft/client/gui/screen/recipebook/RecipeBookWidget;render(Lnet/minecraft/client/gui/DrawContext;IIF)V
 *   Lnet/minecraft/client/gui/screen/recipebook/RecipeBookWidget;drawTooltip(Lnet/minecraft/client/gui/DrawContext;IILnet/minecraft/screen/slot/Slot;)V
 *   Lnet/minecraft/client/gui/screen/ingame/HandledScreen;drawSlots(Lnet/minecraft/client/gui/DrawContext;)V
 *   Lnet/minecraft/client/gui/screen/recipebook/RecipeBookWidget;drawGhostSlots(Lnet/minecraft/client/gui/DrawContext;Z)V
 *   Lnet/minecraft/client/gui/screen/recipebook/RecipeBookWidget;charTyped(Lnet/minecraft/client/input/CharInput;)Z
 *   Lnet/minecraft/client/gui/screen/ingame/HandledScreen;charTyped(Lnet/minecraft/client/input/CharInput;)Z
 *   Lnet/minecraft/client/gui/screen/recipebook/RecipeBookWidget;keyPressed(Lnet/minecraft/client/input/KeyInput;)Z
 *   Lnet/minecraft/client/gui/screen/ingame/HandledScreen;keyPressed(Lnet/minecraft/client/input/KeyInput;)Z
 *   Lnet/minecraft/client/gui/screen/recipebook/RecipeBookWidget;mouseClicked(Lnet/minecraft/client/gui/Click;Z)Z
 *   Lnet/minecraft/client/gui/screen/ingame/HandledScreen;mouseClicked(Lnet/minecraft/client/gui/Click;Z)Z
 *   Lnet/minecraft/client/gui/screen/recipebook/RecipeBookWidget;mouseDragged(Lnet/minecraft/client/gui/Click;DD)Z
 ...
 *   Lnet/minecraft/client/gui/screen/recipebook/RecipeBookWidget;onMouseClick(Lnet/minecraft/screen/slot/Slot;)V
 *   Lnet/minecraft/client/gui/screen/recipebook/RecipeBookWidget;onCraftFailed(Lnet/minecraft/recipe/display/RecipeDisplay;)V
 *
 * Internal private/static methods:
 *   Lnet/minecraft/client/gui/screen/ingame/RecipeBookScreen;addDrawableChild(Lnet/minecraft/client/gui/Element;)Lnet/minecraft/client/gui/Element;
 *   Lnet/minecraft/client/gui/screen/ingame/RecipeBookScreen;addSelectableChild(Lnet/minecraft/client/gui/Element;)Lnet/minecraft/client/gui/Element;
 *   Lnet/minecraft/client/gui/screen/ingame/RecipeBookScreen;renderBackground(Lnet/minecraft/client/gui/DrawContext;IIF)V
 *   Lnet/minecraft/client/gui/screen/ingame/RecipeBookScreen;renderCursorStack(Lnet/minecraft/client/gui/DrawContext;II)V
 *   Lnet/minecraft/client/gui/screen/ingame/RecipeBookScreen;renderLetGoTouchStack(Lnet/minecraft/client/gui/DrawContext;)V
 *   Lnet/minecraft/client/gui/screen/ingame/RecipeBookScreen;drawMouseoverTooltip(Lnet/minecraft/client/gui/DrawContext;II)V
 */
