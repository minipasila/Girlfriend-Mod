 ...
 *   Lnet/minecraft/client/resource/server/ServerResourcePackManager$PackEntry;discard(Lnet/minecraft/client/resource/server/ServerResourcePackManager$DiscardReason;)V
 *   Lnet/minecraft/client/resource/server/PackStateChangeCallback;onFinish(Ljava/util/UUID;Lnet/minecraft/client/resource/server/PackStateChangeCallback$FinishState;)V
 *   Lnet/minecraft/client/resource/server/PackStateChangeCallback;onStateChanged(Ljava/util/UUID;Lnet/minecraft/client/resource/server/PackStateChangeCallback$State;)V
 *   Lnet/minecraft/util/Downloader$DownloadResult;failed()Ljava/util/Set;
 *   Lnet/minecraft/util/Downloader$DownloadResult;downloaded()Ljava/util/Map;
 *   Lnet/minecraft/client/resource/server/DownloadQueuer;enqueue(Ljava/util/Map;Ljava/util/function/Consumer;)V
 *   Lnet/minecraft/client/resource/server/ReloadScheduler;scheduleReload(Lnet/minecraft/client/resource/server/ReloadScheduler$ReloadContext;)V
 *
 * Internal private/static methods:
 *   Lnet/minecraft/client/resource/server/ServerResourcePackManager;onAdd(Ljava/util/UUID;Lnet/minecraft/client/resource/server/ServerResourcePackManager$PackEntry;)V
 *   Lnet/minecraft/client/resource/server/ServerResourcePackManager;markReplaced(Ljava/util/UUID;)V
 *   Lnet/minecraft/client/resource/server/ServerResourcePackManager;accept(Lnet/minecraft/client/resource/server/ServerResourcePackManager$PackEntry;)V
 *   Lnet/minecraft/client/resource/server/ServerResourcePackManager;onDownload(Ljava/util/Collection;Lnet/minecraft/util/Downloader$DownloadResult;)V
 */
