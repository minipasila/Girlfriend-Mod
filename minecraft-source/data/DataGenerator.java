 ...
 *   Lnet/minecraft/data/DataCache;run(Ljava/lang/String;Lnet/minecraft/data/DataCache$Runner;)Ljava/util/concurrent/CompletableFuture;
 *   Lnet/minecraft/data/DataCache;store(Lnet/minecraft/data/DataCache$RunResult;)V
 */
