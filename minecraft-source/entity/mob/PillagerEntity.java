 ...
 *   Lnet/minecraft/entity/mob/IllagerEntity;initDataTracker(Lnet/minecraft/entity/data/DataTracker$Builder;)V
 *   Lnet/minecraft/entity/mob/IllagerEntity;writeCustomData(Lnet/minecraft/storage/WriteView;)V
 *   Lnet/minecraft/entity/mob/IllagerEntity;readCustomData(Lnet/minecraft/storage/ReadView;)V
 *   Lnet/minecraft/entity/mob/IllagerEntity;initialize(Lnet/minecraft/world/ServerWorldAccess;Lnet/minecraft/world/LocalDifficulty;Lnet/minecraft/entity/SpawnReason;Lnet/minecraft/entity/EntityData;)Lnet/minecraft/entity/EntityData;
 *   Lnet/minecraft/entity/mob/IllagerEntity;enchantMainHandItem(Lnet/minecraft/world/ServerWorldAccess;Lnet/minecraft/util/math/random/Random;Lnet/minecraft/world/LocalDifficulty;)V
 ...
 *   Lnet/minecraft/entity/mob/IllagerEntity;loot(Lnet/minecraft/server/world/ServerWorld;Lnet/minecraft/entity/ItemEntity;)V
 ...
 *   Lnet/minecraft/entity/mob/PillagerEntity;writeInventory(Lnet/minecraft/storage/WriteView;)V
 *   Lnet/minecraft/entity/mob/PillagerEntity;readInventory(Lnet/minecraft/storage/ReadView;)V
 *   Lnet/minecraft/entity/mob/PillagerEntity;initEquipment(Lnet/minecraft/util/math/random/Random;Lnet/minecraft/world/LocalDifficulty;)V
 *   Lnet/minecraft/entity/mob/PillagerEntity;updateEnchantments(Lnet/minecraft/world/ServerWorldAccess;Lnet/minecraft/util/math/random/Random;Lnet/minecraft/world/LocalDifficulty;)V
 *   Lnet/minecraft/entity/mob/PillagerEntity;equipStack(Lnet/minecraft/entity/EquipmentSlot;Lnet/minecraft/item/ItemStack;)V
 *   Lnet/minecraft/entity/mob/PillagerEntity;shoot(Lnet/minecraft/entity/LivingEntity;F)V
 *   Lnet/minecraft/entity/mob/PillagerEntity;triggerItemPickedUpByEntityCriteria(Lnet/minecraft/entity/ItemEntity;)V
 */
