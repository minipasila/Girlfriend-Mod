 ...
 *   Lnet/minecraft/entity/passive/SheepColors$SpawnConfig;colors()Lnet/minecraft/entity/passive/SheepColors$ColorSelector;
 *   Lnet/minecraft/util/collection/Pool;builder()Lnet/minecraft/util/collection/Pool$Builder;
 *
 * Internal private/static methods:
 *   Lnet/minecraft/entity/passive/SheepColors;poolBuilder()Lnet/minecraft/util/collection/Pool$Builder;
 *   Lnet/minecraft/entity/passive/SheepColors;createSingleSelector(Lnet/minecraft/util/DyeColor;)Lnet/minecraft/entity/passive/SheepColors$ColorSelector;
 *   Lnet/minecraft/entity/passive/SheepColors;createCombinedSelector(Lnet/minecraft/util/collection/Pool;)Lnet/minecraft/entity/passive/SheepColors$ColorSelector;
 *   Lnet/minecraft/entity/passive/SheepColors;createDefaultSelector(Lnet/minecraft/util/DyeColor;)Lnet/minecraft/entity/passive/SheepColors$ColorSelector;
 */
