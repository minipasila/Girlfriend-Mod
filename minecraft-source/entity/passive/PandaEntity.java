 ...
 *   Lnet/minecraft/entity/passive/PandaEntity$Gene;createRandom(Lnet/minecraft/util/math/random/Random;)Lnet/minecraft/entity/passive/PandaEntity$Gene;
 ...
 *   Lnet/minecraft/entity/passive/AnimalEntity;tryAttack(Lnet/minecraft/server/world/ServerWorld;Lnet/minecraft/entity/Entity;)Z
 ...
 *   Lnet/minecraft/entity/passive/PandaEntity;playSound(Lnet/minecraft/sound/SoundEvent;FF)V
 *   Lnet/minecraft/entity/passive/PandaEntity;lookAtEntity(Lnet/minecraft/entity/Entity;FF)V
 *   Lnet/minecraft/entity/passive/PandaEntity;equipStack(Lnet/minecraft/entity/EquipmentSlot;Lnet/minecraft/item/ItemStack;)V
 *   Lnet/minecraft/entity/passive/PandaEntity;emitGameEvent(Lnet/minecraft/registry/entry/RegistryEntry;)V
 *   Lnet/minecraft/entity/passive/PandaEntity;forEachGiftedItem(Lnet/minecraft/server/world/ServerWorld;Lnet/minecraft/registry/RegistryKey;Ljava/util/function/BiConsumer;)Z
 *   Lnet/minecraft/entity/passive/PandaEntity;triggerItemPickedUpByEntityCriteria(Lnet/minecraft/entity/ItemEntity;)V
 *   Lnet/minecraft/entity/passive/PandaEntity;sendPickup(Lnet/minecraft/entity/Entity;I)V
 *   Lnet/minecraft/entity/passive/PandaEntity;eat(Lnet/minecraft/entity/player/PlayerEntity;Lnet/minecraft/util/Hand;Lnet/minecraft/item/ItemStack;)V
 *   Lnet/minecraft/entity/passive/PandaEntity;growUp(IZ)V
 *   Lnet/minecraft/entity/passive/PandaEntity;lovePlayer(Lnet/minecraft/entity/player/PlayerEntity;)V
 *   Lnet/minecraft/entity/passive/PandaEntity;dropStack(Lnet/minecraft/server/world/ServerWorld;Lnet/minecraft/item/ItemStack;)Lnet/minecraft/entity/ItemEntity;
 */
