 ...
 *   Lnet/minecraft/entity/passive/CamelBrain;initialize(Lnet/minecraft/entity/passive/CamelEntity;Lnet/minecraft/util/math/random/Random;)V
 ...
 *   Lnet/minecraft/entity/passive/CamelBrain;createBrainProfile()Lnet/minecraft/entity/ai/brain/Brain$Profile;
 ...
 *   Lnet/minecraft/entity/passive/CamelBrain;create(Lnet/minecraft/entity/ai/brain/Brain;)Lnet/minecraft/entity/ai/brain/Brain;
 ...
 *   Lnet/minecraft/entity/passive/CamelBrain;updateActivities(Lnet/minecraft/entity/passive/CamelEntity;)V
 *   Lnet/minecraft/entity/passive/AbstractHorseEntity;mobTick(Lnet/minecraft/server/world/ServerWorld;)V
 ...
 *   Lnet/minecraft/entity/passive/AbstractHorseEntity;travel(Lnet/minecraft/util/math/Vec3d;)V
 *   Lnet/minecraft/entity/passive/AbstractHorseEntity;tickControlled(Lnet/minecraft/entity/player/PlayerEntity;Lnet/minecraft/util/math/Vec3d;)V
 ...
 *   Lnet/minecraft/entity/passive/AbstractHorseEntity;applyDamage(Lnet/minecraft/server/world/ServerWorld;Lnet/minecraft/entity/damage/DamageSource;F)V
 *   Lnet/minecraft/entity/passive/AbstractHorseEntity;onTrackedDataSet(Lnet/minecraft/entity/data/TrackedData;)V
 ...
 *   Lnet/minecraft/entity/passive/CamelEntity;createBaseHorseAttributes()Lnet/minecraft/entity/attribute/DefaultAttributeContainer$Builder;
 *   Lnet/minecraft/entity/passive/CamelEntity;initLastPoseTick(J)V
 *   Lnet/minecraft/entity/passive/CamelEntity;createBrainProfile()Lnet/minecraft/entity/ai/brain/Brain$Profile;
 *   Lnet/minecraft/entity/passive/CamelEntity;addVelocityInternal(Lnet/minecraft/util/math/Vec3d;)V
 *   Lnet/minecraft/entity/passive/CamelEntity;playSound(Lnet/minecraft/sound/SoundEvent;)V
 *   Lnet/minecraft/entity/passive/CamelEntity;emitGameEvent(Lnet/minecraft/registry/entry/RegistryEntry;)V
 *   Lnet/minecraft/entity/passive/CamelEntity;playSound(Lnet/minecraft/sound/SoundEvent;FF)V
 *   Lnet/minecraft/entity/passive/CamelEntity;openInventory(Lnet/minecraft/entity/player/PlayerEntity;)V
 *   Lnet/minecraft/entity/passive/CamelEntity;interactHorse(Lnet/minecraft/entity/player/PlayerEntity;Lnet/minecraft/item/ItemStack;)Lnet/minecraft/util/ActionResult;
 *   Lnet/minecraft/entity/passive/CamelEntity;putPlayerOnBack(Lnet/minecraft/entity/player/PlayerEntity;)V
 *   Lnet/minecraft/entity/passive/CamelEntity;wouldNotSuffocateInPose(Lnet/minecraft/entity/EntityPose;)Z
 *   Lnet/minecraft/entity/passive/CamelEntity;heal(F)V
 *   Lnet/minecraft/entity/passive/CamelEntity;lovePlayer(Lnet/minecraft/entity/player/PlayerEntity;)V
 *   Lnet/minecraft/entity/passive/CamelEntity;growUp(I)V
