 ...
 *   Lnet/minecraft/entity/mob/WaterCreatureEntity;initDataTracker(Lnet/minecraft/entity/data/DataTracker$Builder;)V
 *   Lnet/minecraft/entity/mob/WaterCreatureEntity;writeCustomData(Lnet/minecraft/storage/WriteView;)V
 *   Lnet/minecraft/storage/WriteView;putBoolean(Ljava/lang/String;Z)V
 *   Lnet/minecraft/entity/mob/WaterCreatureEntity;readCustomData(Lnet/minecraft/storage/ReadView;)V
 *   Lnet/minecraft/entity/mob/WaterCreatureEntity;travel(Lnet/minecraft/util/math/Vec3d;)V
 ...
 *   Lnet/minecraft/entity/mob/WaterCreatureEntity;interactMob(Lnet/minecraft/entity/player/PlayerEntity;Lnet/minecraft/util/Hand;)Lnet/minecraft/util/ActionResult;
 ...
 *   Lnet/minecraft/entity/passive/FishEntity;updateVelocity(FLnet/minecraft/util/math/Vec3d;)V
 *   Lnet/minecraft/entity/passive/FishEntity;move(Lnet/minecraft/entity/MovementType;Lnet/minecraft/util/math/Vec3d;)V
 *   Lnet/minecraft/entity/passive/FishEntity;playSound(Lnet/minecraft/sound/SoundEvent;)V
 */
