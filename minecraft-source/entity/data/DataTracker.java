 ...
 *   Lnet/minecraft/entity/data/DataTracker$Entry;toSerialized()Lnet/minecraft/entity/data/DataTracker$SerializedEntry;
 *   Lnet/minecraft/entity/data/DataTracked;onDataTrackerUpdate(Ljava/util/List;)V
 *   Lnet/minecraft/entity/data/DataTracker$SerializedEntry;handler()Lnet/minecraft/entity/data/TrackedDataHandler;
