 ...
 *   Lnet/minecraft/item/ItemGroup$Builder;displayName(Lnet/minecraft/text/Text;)Lnet/minecraft/item/ItemGroup$Builder;
 *   Lnet/minecraft/item/ItemGroup$Builder;icon(Ljava/util/function/Supplier;)Lnet/minecraft/item/ItemGroup$Builder;
 *   Lnet/minecraft/item/ItemGroup$Builder;entries(Lnet/minecraft/item/ItemGroup$EntryCollector;)Lnet/minecraft/item/ItemGroup$Builder;
 *   Lnet/minecraft/item/ItemGroup$Builder;build()Lnet/minecraft/item/ItemGroup;
 ...
 *   Lnet/minecraft/item/ItemGroup$Builder;special()Lnet/minecraft/item/ItemGroup$Builder;
 *   Lnet/minecraft/item/ItemGroup$Builder;type(Lnet/minecraft/item/ItemGroup$Type;)Lnet/minecraft/item/ItemGroup$Builder;
 *   Lnet/minecraft/item/ItemGroup$Builder;texture(Lnet/minecraft/util/Identifier;)Lnet/minecraft/item/ItemGroup$Builder;
 *   Lnet/minecraft/item/ItemGroup$Builder;noRenderedName()Lnet/minecraft/item/ItemGroup$Builder;
 *   Lnet/minecraft/item/ItemGroup$Builder;noScrollbar()Lnet/minecraft/item/ItemGroup$Builder;
 ...
 *   Lnet/minecraft/item/ItemGroup$Entries;addAll(Ljava/util/Collection;Lnet/minecraft/item/ItemGroup$StackVisibility;)V
 ...
 *   Lnet/minecraft/item/ItemGroup$DisplayContext;doesNotMatch(Lnet/minecraft/resource/featuretoggle/FeatureSet;ZLnet/minecraft/registry/RegistryWrapper$WrapperLookup;)Z
 ...
 *   Lnet/minecraft/item/ItemGroup$DisplayContext;lookup()Lnet/minecraft/registry/RegistryWrapper$WrapperLookup;
 *   Lnet/minecraft/item/ItemGroup$DisplayContext;enabledFeatures()Lnet/minecraft/resource/featuretoggle/FeatureSet;
 *   Lnet/minecraft/item/ItemGroup$Entries;addAll(Ljava/util/Collection;)V
 *   Lnet/minecraft/item/CopperBlockItemSet;forEach(Ljava/util/function/Consumer;)V
 ...
 *   Lnet/minecraft/item/CopperBlockItemSet;unaffected()Lnet/minecraft/item/Item;
 *   Lnet/minecraft/item/CopperBlockItemSet;exposed()Lnet/minecraft/item/Item;
 *   Lnet/minecraft/item/CopperBlockItemSet;weathered()Lnet/minecraft/item/Item;
 *   Lnet/minecraft/item/CopperBlockItemSet;oxidized()Lnet/minecraft/item/Item;
 *   Lnet/minecraft/item/CopperBlockItemSet;waxed()Lnet/minecraft/item/Item;
 *   Lnet/minecraft/item/CopperBlockItemSet;waxedExposed()Lnet/minecraft/item/Item;
 *   Lnet/minecraft/item/CopperBlockItemSet;waxedWeathered()Lnet/minecraft/item/Item;
 *   Lnet/minecraft/item/CopperBlockItemSet;waxedOxidized()Lnet/minecraft/item/Item;
 *
 * Internal private/static methods:
 *   Lnet/minecraft/item/ItemGroups;stream()Ljava/util/stream/Stream;
 *   Lnet/minecraft/item/ItemGroups;updateEntries(Lnet/minecraft/item/ItemGroup$DisplayContext;)V
 *   Lnet/minecraft/item/ItemGroups;addPaintings(Lnet/minecraft/item/ItemGroup$Entries;Lnet/minecraft/registry/RegistryWrapper$WrapperLookup;Lnet/minecraft/registry/RegistryWrapper$Impl;Ljava/util/function/Predicate;Lnet/minecraft/item/ItemGroup$StackVisibility;)V
 *   Lnet/minecraft/item/ItemGroups;addMaxLevelEnchantedBooks(Lnet/minecraft/item/ItemGroup$Entries;Lnet/minecraft/registry/RegistryWrapper;Lnet/minecraft/item/ItemGroup$StackVisibility;)V
 *   Lnet/minecraft/item/ItemGroups;addAllLevelEnchantedBooks(Lnet/minecraft/item/ItemGroup$Entries;Lnet/minecraft/registry/RegistryWrapper;Lnet/minecraft/item/ItemGroup$StackVisibility;)V
 *   Lnet/minecraft/item/ItemGroups;addSuspiciousStews(Lnet/minecraft/item/ItemGroup$Entries;Lnet/minecraft/item/ItemGroup$StackVisibility;)V
 *   Lnet/minecraft/item/ItemGroups;addOminousBottles(Lnet/minecraft/item/ItemGroup$Entries;Lnet/minecraft/item/ItemGroup$StackVisibility;)V
 *   Lnet/minecraft/item/ItemGroups;addPotions(Lnet/minecraft/item/ItemGroup$Entries;Lnet/minecraft/registry/RegistryWrapper;Lnet/minecraft/item/Item;Lnet/minecraft/item/ItemGroup$StackVisibility;Lnet/minecraft/resource/featuretoggle/FeatureSet;)V
 *   Lnet/minecraft/item/ItemGroups;addFireworkRockets(Lnet/minecraft/item/ItemGroup$Entries;Lnet/minecraft/item/ItemGroup$StackVisibility;)V
 *   Lnet/minecraft/item/ItemGroups;addInstruments(Lnet/minecraft/item/ItemGroup$Entries;Lnet/minecraft/registry/RegistryWrapper;Lnet/minecraft/item/Item;Lnet/minecraft/registry/tag/TagKey;Lnet/minecraft/item/ItemGroup$StackVisibility;)V
 *   Lnet/minecraft/item/ItemGroups;register(Ljava/lang/String;)Lnet/minecraft/registry/RegistryKey;
 */
